...
export default function TokenPage({
  ...
  // Ventana de preventa depende del tipo de campaña y nivel
  const ventanaMap: Record<string, string> = {
    Bronce: c.type === "official" ? "Preventa estándar (acceso normal)" : "Info anticipada si se confirma",
    Plata: c.type === "official" ? "Preventa 24 hs antes del público" : "Info anticipada + posición prioritaria",
    Oro: c.type === "official" ? "Preventa 48 hs antes del público" : "Info anticipada + primera posición",
  };
