...
import { CountdownTimer, UrgencyBanner } from "@/components/ui/CountdownTimer";
import { ShareButton } from "@/components/ui/ShareButton";

export const metadata: Metadata = {
  title: "Campañas activas",
  description: "Explorá las campañas de demanda verificada para conciertos y eventos en vivo. Apoyá antes que se confirme el show.",
};
  ...
  return (
    <div style={{ padding: "32px 0 60px" }}>
      <div className="wrap">
        ...
        {/* Urgency banner */}
        <UrgencyBanner campaigns={campaigns.map(c => ({ days: c.days, artist: c.artist }))} />
            ...
            return (
              ...
              >
                ...
                <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginTop:10, flexWrap:"wrap", gap:8 }}>
                  <CountdownTimer days={c.days} />
                  <ShareButton artist={c.artist} city={c.city} campaignId={c.id} />
                </div>
              </div>
            );
          })}
