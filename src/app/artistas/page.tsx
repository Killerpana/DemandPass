...
export const metadata: Metadata = {
  ...
  description: "Medí demanda real antes de confirmar tu show. Creá campañas, entendé dónde están tus fans.",
};
...
const BENEFICIOS = [
  ...
  { Icon: BarChart2,       title: "Campañas propias",           desc: "Creá tu campaña de fan demand o campaña oficial verificada por DemandPass." },
  { Icon: Map,             title: "Planificá mini-giras",       desc: "Demand Map te muestra qué ciudades pueden sostener una fecha tuya." },
  { Icon: Gift,            title: "Beneficios para tus fans",   desc: "Meet & greet, charla virtual, acceso a ensayo, merch — vos definís qué ofrecés." },
  { Icon: LayoutDashboard, title: "Dashboard propio",           desc: "Estadísticas de tu campaña: apoyos, ciudades top, rango de precio, Demand Score." },
];

const PLANES = [
  { nombre: "Starter", precio: "Gratis",  items: ["1 campaña fan demand", "Hasta 500 apoyos", "Estadísticas básicas", "Perfil verificado"],                                                                   highlight: false },
  { nombre: "Indie",   precio: "USD 29",  sub: "por campaña", items: ["3 campañas activas", "Apoyos ilimitados", "Demand Score + Map", "Beneficios personalizados", "Dashboard completo", "Soporte por email"], highlight: true  },
  { nombre: "Pro",     precio: "USD 79",  sub: "por mes",     items: ["Campañas ilimitadas", "Todo lo de Indie", "Tour Expansion Intelligence", "Fan Signals avanzado", "Soporte prioritario"],                 highlight: false },
];
        ...
        <div className="max-w-[1100px] mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="font-[family-name:var(--font-display)] text-[clamp(28px,4vw,48px)] font-black uppercase">
              EMPEZÁ GRATIS.<br /><span style={{ color: "var(--color-txt3)" }}>ESCALÁ CUANDO ESTÉS LISTO.</span>
            </h2>
          </div>
            ...
            {PLANES.map(p => (
              <div key={p.nombre} className="relative p-7 rounded-xl flex flex-col"
                ...
                <div className="flex items-baseline gap-1.5 mb-5">
                  <span className="font-[family-name:var(--font-display)] text-[34px] font-black">{p.precio}</span>
