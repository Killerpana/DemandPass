...
import { Compass, Ticket, Search, Bell, Clock, User, Settings, ChevronRight, LogOut } from "lucide-react";
import { Logo } from "@/components/ui/Logo";

const NAV = [
  { label: "Campañas",         href: "/campaigns",  Icon: Compass, badge: null },
  { label: "Mis DemandPasses", href: "/perfil",     Icon: Ticket,  badge: "3"  },
  { label: "Descubrir",        href: "/campaigns",  Icon: Search,  badge: null },
  { label: "Alertas",          href: "/perfil",     Icon: Bell,    badge: "2"  },
  { label: "Historial",        href: "/perfil",     Icon: Clock,   badge: null },
];
      ...
      <aside className="hidden md:flex w-[220px] shrink-0 flex-col border-r"
        ...
        <div className="px-4 pt-5 pb-4 border-b" style={{ borderColor: "var(--color-border)" }}>
          ...
          <div className="mt-3 flex items-center gap-2">
            ...
            <div>
              <p className="text-[12px] font-bold leading-tight">Facundo Barile</p>
        ...
        <nav className="flex flex-col gap-0.5 px-2 py-3 flex-1">
          {NAV.map(({ label, href, Icon, badge }) => {
            const active = path === href || (href === "/perfil" && path.startsWith("/perfil"));
            return (
